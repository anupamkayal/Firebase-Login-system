...
MDFloatLayout:
	...
	MDCard:
		...
		MDFloatLayout:
			...
			IconToggleButton:
				id:toggle_btn
				icon:{'normal':'./Eye-off button ico/eye.png','down':'./Eye-off button ico/visibility-button.png'}[self.state]
			...
			Button:
				...
				background_normal:'./Eye-off button ico/Login_btn.png'
				background_down:'./Eye-off button ico/Login_btn.png'
				allow_stretch:True
				on_press:app.login_func()
			MDTextButton:
